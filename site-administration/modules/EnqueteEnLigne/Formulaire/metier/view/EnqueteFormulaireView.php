...
class EnqueteFormulaireView {
	...
	public function renderHTML() {
		...
		$aff .= '<tr><td>Statut</td><td>';

		switch ($this->myFormulaire->getStatut ()) {
			case '1' :
				$aff .= '<input type="radio" name="statut" value="1" checked>En attente <input type="radio" name="statut" value="2">En cours <input type="radio" name="statut" value="3">Fini';
				break;
			case '2' :
				$aff .= '<input type="radio" name="statut" value="1">En attente <input type="radio" name="statut" value="2" checked>En cours <input type="radio" name="statut" value="3">Fini';
				break;
			case '3' :
				$aff .= '<input type="radio" name="statut" value="1">En attente <input type="radio" name="statut" value="2">En cours <input type="radio" name="statut" value="3" checked>Fini';
				break;
		}
		$aff .= '</td></tr>';
		$aff .= '</table>';
		...
		if (isset ( $_GET ['id'] )) {
			...
			$aff .= '<option value="101">Champ - Text Simple (Obligatoire)</option>';
