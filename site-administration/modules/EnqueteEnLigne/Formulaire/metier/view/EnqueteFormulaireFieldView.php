<?php
class EnqueteFormulaireFieldView {
	private $myField;
	public function __construct($enqueteFormulaireField) {
		$this->myField = $enqueteFormulaireField;
	}
	public function renderHTML() {
		...
		switch ($_GET ['type']) {
			case '1' :
				...
				break;
			case '101' :
				$aff .= '<h3>Champ - Text simple Obligatoire</h3>';
				break;
			case '2' :
