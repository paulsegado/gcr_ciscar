<?php
class EnqueteFormulaireListView {
	private $myList;
	...
	public function renderHTML() {
		$aff = '<div id="FilAriane"><a href="../../../modules/EnqueteEnLigne/Formulaire/?">Enquete</a>&nbsp;>&nbsp;Formulaires</div><br/><br/>';
		...
		$aff .= '	<td align="center"><b>Lien</b></td>';
		$aff .= '	<td align="center"><b>Statut</b></td>';
		...
		foreach ( $this->myList as $formulaire ) {
			...
			$aff .= '	<td class="' . ($row == 1 ? 'row1' : 'row2') . '"><a href="/enkete.php?id=' . $formulaire->getID () . '" target="_blank" >http://gcrfrance.com/enkete.php?id=' . $formulaire->getID () . '</a></td>';
			//$aff .= '	<td class="' . ($row == 1 ? 'row1' : 'row2') . '"><a href="/enquete.php?id=' . $formulaire->getID () . '" target="_blank" >http://gcrfrance.com/enquete.php?id=' . $formulaire->getID () . '</a></td>';
			$aff .= '	<td class="' . ($row == 1 ? 'row1' : 'row2') . '" align="center" >' . $statut . '</td>';
			...
			$aff .= '	<td class="' . ($row == 1 ? 'row1' : 'row2') . '" width="50" align="center"><a href="../index.php?form-preview=' . $formulaire->getID () . '" target="_BLANK"><img border="0" src="../../../include/images/1299158947_preview_16x16.gif"></a></td>';
