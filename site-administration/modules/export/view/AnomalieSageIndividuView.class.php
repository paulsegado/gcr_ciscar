 ...
 * @version 1.0.4
 */
class AnomalieSageIndividuView implements DefaultListView {
	private $myList;
	private $nbrEntre;
	...
	public function renderHTML() {
		...
		$aff .= '	<a href="../../?menu=1">Général</a>&nbsp;>&nbsp;<a href="?">Export</a>&nbsp;>&nbsp;Anomalie Individu sans LoginSage';
		$aff .= '</div><br/><br/>';
		...
		$aff .= '<tr class="title">';
		$aff .= '<td align="center" width="50"><a href="?action=anomalie_Sageindividu&tri=1&ordre=' . $sens . $rech . '"><b>#</b></a></td>';
		$aff .= '<td align="center"><a href="?action=anomalie_Sageindividu&tri=2&ordre=' . $sens . $rech . '"><b>Nom</b></a></td>';
		$aff .= '<td align="center"><a href="?action=anomalie_Sageindividu&tri=3&ordre=' . $sens . $rech . '"><b>Prenom</b></a></td>';
		$aff .= '<td align="center"><a href="?action=anomalie_Sageindividu&tri=4&ordre=' . $sens . $rech . '"><b>Mail</b></a></td>';
		...
		$aff .= '<script>
                ...
                $("#Pagination").pagination(num_entries, {
					...
					link_to:\'?action=anomalie_Sageindividu&page=__id__' . $tri . $ordre . $rech . '\',
