...
<script type="text/javascript">
	  	function NoDelete()
		{
			alert('Ce Domaine d\'activité est utilisé par un ou plusieurs role(s)!');
		}
  	</script>
<style>
label {
...
if ($_SESSION ['ADMIN'] ['USER'] ['CONNECTED']) {
	...
	if (isset ( $_GET ['action'] )) {
		$aDomaineActiviteControler = new DomaineActiviteControler ();
		$aDomaineActiviteControler->run ();
	}
	...
	if (! isset ( $_GET ['action'] )) {
		...
		$aDomaineActiviteListeView = new DomaineActiviteListeView ( $aDomaineActiviteListe );
		$aDomaineActiviteListeView->render ();
	}
