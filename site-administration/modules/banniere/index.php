...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-15" />
	...
	echo HelperHead::includeJS ( '../../include/js/BanniereScript.js' );
	echo HelperHead::includeJS ( '../../include/js/CheckDate.js' );
	?>
...
if ($_SESSION ['ADMIN'] ['USER'] ['CONNECTED']) {
	...
	if (isset ( $_GET ['action'] )) {
		$aControler = new BanniereControler ();
		$aControler->run ();
	} else {
		$aList = new BanniereList ();
		$aList->SQL_select_all ();
		$aView = new BanniereListView ( $aList->getList () );
		$aView->render ();
	}
