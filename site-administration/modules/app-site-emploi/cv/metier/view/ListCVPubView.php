...
class ListCVPubView {
	...
	public function renderHTML() {
		...
		foreach ( $this->myList->getList () as $aVerif ) {
			$aff .= '<tr>';
			$aff .= '	<td class="center" width="50">' . $aVerif->getnumcv () . '</td>';
