...
class ListOffreNumView {
	...
	public function renderHTML() {
		...
		$aff .= '<a href="?action=offres&list">Offres</a>&nbsp;>&nbsp;Liste des offres triées par numéro<br /><br /></b>';
		// Button Bar
		// $aff .= '<br/><br/>';
