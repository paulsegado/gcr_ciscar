<?php
/**
 * Export des cv par région et domaine
	...
	if (isset ( $_GET ['export'] )) {
		...
		switch ($_GET ['export']) {
			...
			case 1 :
				...
				header ( 'Content-Type:application/application/csv-tab-delimited-table' );
				header ( 'Content-disposition: filename="CV par région et domaine ' . FunctionDate::getMois ( $_GET ['m'] ) . ' ' . $_GET ['a'] . '.csv"' );
			...
			case 2 :
				...
				header ( 'Content-disposition: filename="CV par région et domaine .csv"' );
