<?php
/**
 * Export des offres par région et domaine
	...
	if (isset ( $_GET ['export'] )) {
		...
		switch ($_GET ['export']) {
			...
			case 1 :
				...
				header ( 'Content-disposition: filename="Offres par région et domaine ' . FunctionDate::getMois ( $_GET ['m'] ) . ' ' . $_GET ['a'] . '.csv"' );
			...
			case 2 :
				...
				header ( 'Content-Type: application/csv-tab-delimited-table' );
				header ( 'Content-disposition: filename="Offres par région et domaine.csv"' );
