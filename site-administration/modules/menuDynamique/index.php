...
<!--  <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-15" /> -->
	...
	echo HelperHead::includeJS ( '../../include/js/MenuDynamique.js' );
	?>
...
if ($_SESSION ['ADMIN'] ['USER'] ['CONNECTED']) {
	...
	if (isset ( $_GET ['action'] )) {
		$aMenuDynamiqueControler = new MenuDynamiqueControler ();
		$aMenuDynamiqueControler->run ();
	} else {
		$aMenuDynamiqueTreeView = new MenuDynamiqueTreeView ();
		$aMenuDynamiqueTreeView->renderHTML ();
	}
