...
class PGDocStaticListView {
	...
	public function render() {
		// Navigation bar
		$aff = '<div id="FilAriane">Web Content&nbsp;>&nbsp;DocStatic</div><br/><br/>';
		...
		foreach ( $this->myList as $aDocStatic ) {
			...
			$aff .= '	<td class="' . ($i == 0 ? 'row1' : 'row2') . '" width="50" align="center"><a onclick="Form.DocStatic.ok(\'' . $aDocStatic->getID () . '\', \'' . $aDocStatic->getTitre () . '\')"><img src="../../../include/images/add.png" border=0/></a></td>';
			$aff .= '</tr>';
