...
class DocInfoDynCommentaireManager {
	...
	public function add(DocInfoDynCommentaire $aDocInfoDynCommentaire) {
		...
		$query = sprintf ( $sql, mysqli_real_escape_string ($_SESSION['LINK'], $_SESSION ['ADMIN'] ['USER'] ['AnnuaireID'] ), mysqli_real_escape_string ($_SESSION['LINK'], $aDocInfoDynCommentaire->getAuthorID () ), mysqli_real_escape_string ($_SESSION['LINK'], $aDocInfoDynCommentaire->getDocInfoDynID () ), mysqli_real_escape_string ($_SESSION['LINK'], $aDocInfoDynCommentaire->getDateCreation () ), mysqli_real_escape_string ($_SESSION['LINK'], $aDocInfoDynCommentaire->getRichTextContentValue () ) );
	...
	public function get($aCommentaireID) {
		$sql = "SELECT CommentaireID, AuthorID,DocInfoDynID, DateCreation, RichContentValue, SiteID ";
	...
	public function getList($aDocInfoDynID, $debut = -1, $limite = -1) {
		...
		$sql .= " ORDER BY CommentaireID DESC";
