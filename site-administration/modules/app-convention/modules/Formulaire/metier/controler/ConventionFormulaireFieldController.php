<?php
class ConventionFormulaireFieldController {
	public function run() {
	...
	private function editAction() {
		if (isset ( $_POST ['question'] )) {
			$field = new ConventionFormulaireField ();
			$fieldDAO = new ConventionFormulaireFieldDAO ();
			...
			$dao = new ConventionFormulaireFieldDAO ();
			$view = new ConventionFormulaireFieldView ( $dao->find ( $_GET ['compoid'] ) );
			$view->renderHTML ();
		}
	}
	...
	private function defaultAction() {
		if (isset ( $_POST ['question'] )) {
			...
			$composition->setType ( ConventionFormulaireComposition::TYPE_FIELD );
			...
			$view = new ConventionFormulaireFieldView ( $instance );
			$view->renderHTML ();
		}
	}
