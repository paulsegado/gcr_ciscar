...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-15" />
	...
	<script type="text/javascript">
		function NoDelete()
		{
			alert('Cette catégorie ne peut être supprimée car elle contient des documents!');
		}
	
	    function confirmDelete(doc_id)
	    {
	    	if(confirm("Confirmation de suppression (Attention les catégories filles vont également etre supprimées)"))
	    	{
