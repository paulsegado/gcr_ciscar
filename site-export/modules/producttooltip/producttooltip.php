...
class ProductToolTip extends Module {
	...
	public function uninstall() {
		if (! Configuration::deleteByName ( 'PS_PTOOLTIP_PEOPLE' ) || ! Configuration::deleteByName ( 'PS_PTOOLTIP_DATE_CART' ) || ! Configuration::deleteByName ( 'PS_PTOOLTIP_DATE_ORDER' ) || ! Configuration::deleteByName ( 'PS_PTOOLTIP_DAYS' ) || ! Configuration::deleteByName ( 'PS_PTOOLTIP_LIFETIME' ) || ! parent::uninstall ())
			return false;
				...
				'form' => array (
						...
						'input' => array (
								array (
										...
										'desc' => $this->l ( 'Display the number of visitors who are currently watching this product.' ) . '<br>' . $this->l ( 'If you activate the option above, you must activate the first option ("Save page views for each customer") of the "Data mining for statistics" (StatsData) module.' ),
								...
								array (
										...
										'desc' => $this->l ( 'Set the reference period length.' ) . '<br>' . $this->l ( 'For instance, if set to 30 minutes, the module will display the number of visitors in the last 30 minutes.' ),
