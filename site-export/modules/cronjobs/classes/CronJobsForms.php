...
class CronJobsForms {
		...
		$form = array (
				array (
						'form' => array (
								...
								'input' => array (),
								'submit' => array (
										'title' => self::$module->l ( 'Save', 'CronJobsForms' ),
										'type' => 'submit',
	...
	public static function getFormValues() {
		...
		return array (
				...
				'advanced_help' => '<div class="alert alert-info">
                    <p>' . self::$module->l ( 'The Advanced mode enables you to use your own cron tasks manager instead of PrestaShop cron tasks webservice.', 'CronJobsForms' ) . ' ' . self::$module->l ( 'First of all, make sure the \'curl\' library is installed on your server.', 'CronJobsForms' ) . '<br />' . self::$module->l ( 'To execute your cron tasks, please insert the following line in your cron tasks manager:', 'CronJobsForms' ) . '
                    </p>
                    <br />
	...
	public static function getTasksList() {
		return array (
				'description' => array (
						'title' => self::$module->l ( 'Task description', 'CronJobsForms' ),
						'type' => 'text',
						'orderby' => false 
				),
				'task' => array (
						'title' => self::$module->l ( 'Target link', 'CronJobsForms' ),
						'type' => 'text',
						'orderby' => false 
				),
				'hour' => array (
						'title' => self::$module->l ( 'Hour', 'CronJobsForms' ),
						'type' => 'text',
						'orderby' => false 
				),
				'day' => array (
						'title' => self::$module->l ( 'Day', 'CronJobsForms' ),
						'type' => 'text',
						'orderby' => false 
				),
				'month' => array (
						'title' => self::$module->l ( 'Month', 'CronJobsForms' ),
						'type' => 'text',
						'orderby' => false 
				),
				'day_of_week' => array (
						'title' => self::$module->l ( 'Day of week', 'CronJobsForms' ),
						'type' => 'text',
						'orderby' => false 
				),
				'updated_at' => array (
						'title' => self::$module->l ( 'Last execution', 'CronJobsForms' ),
						'type' => 'text',
						'orderby' => false 
				),
				'one_shot' => array (
						'title' => self::$module->l ( 'One shot', 'CronJobsForms' ),
						'active' => 'oneshot',
						'type' => 'bool',
						'align' => 'center' 
				),
				'active' => array (
						'title' => self::$module->l ( 'Active', 'CronJobsForms' ),
						'active' => 'status',
						'type' => 'bool',
						'align' => 'center',
						'orderby' => false 
	...
	protected static function getHoursFormOptions() {
		$data = array (
				array (
						'id' => '-1',
						'name' => self::$module->l ( 'Every hour', 'CronJobsForms' ) 
				) 
		);
		...
		for($hour = 0; $hour < 24; $hour += 1) {
			$data [] = array (
					'id' => $hour,
					'name' => date ( 'H:i', mktime ( $hour, 0, 0, 0, 1 ) ) 
			);
		}
	...
	protected static function getDaysFormOptions() {
		$data = array (
				array (
						'id' => '-1',
						'name' => self::$module->l ( 'Every day of the month', 'CronJobsForms' ) 
				) 
		);
	...
	protected static function getMonthsFormOptions() {
		$data = array (
				array (
						'id' => '-1',
						'name' => self::$module->l ( 'Every month', 'CronJobsForms' ) 
				) 
		);
		...
		for($month = 1; $month <= 12; $month += 1) {
			$data [] = array (
					'id' => $month,
					'name' => self::$module->l ( date ( 'F', mktime ( 0, 0, 0, $month, 1 ) ) ) 
			);
		}
	...
	protected static function getDaysofWeekFormOptions() {
		$data = array (
				array (
						'id' => '-1',
						'name' => self::$module->l ( 'Every day of the week', 'CronJobsForms' ) 
				) 
		);
		...
		for($day = 1; $day <= 7; $day += 1) {
			$data [] = array (
					'id' => $day,
					'name' => self::$module->l ( date ( 'l', strtotime ( 'Sunday +' . $day . ' days' ) ) ) 
			);
		}
