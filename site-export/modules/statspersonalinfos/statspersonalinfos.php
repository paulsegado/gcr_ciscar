	...
	public function hookAdminStatsModules() {
		$this->html = '
			...
			<div class="alert alert-warning">
				...
				<p>' . $this->l ( 'In order for each message to have an impact, you need to know who it is being addressed to. ' ) . '<br>' . $this->l ( 'Defining your target audience is essential when choosing the right tools to win them over.' ) . '<br>' . $this->l ( 'It is best to limit an action to a group -- or to groups -- of clients.' ) . '<br>' . $this->l ( 'Storing registered customer information allows you to accurately define customer profiles so you can adapt your special deals and promotions.' ) . '
				</p>
				<div>
