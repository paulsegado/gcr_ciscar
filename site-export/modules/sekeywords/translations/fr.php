...
$_MODULE ['<{sekeywords}prestashop>sekeywords_8effa630c1740a748801b881acb90fa6'] = 'Affiche les mots clés qui ont mené les visiteurs jusqu\'à votre boutique.';
...
$_MODULE ['<{sekeywords}prestashop>sekeywords_7acbda50735929f05f6f463e05bc7ead'] = 'Il s\'agit d\'une des manières les plus connues de trouver un site web par le biais d\'un moteur de recherche.';
$_MODULE ['<{sekeywords}prestashop>sekeywords_4ad084c0b816ff9278765a00720caf32'] = 'Identifier les mots-clés les plus populaires saisis par vos nouveaux visiteurs vous permet de voir les produits que vous devriez mettre en avant si vous voulez avoir une meilleure visibilité dans les moteurs de recherche.';
$_MODULE ['<{sekeywords}prestashop>sekeywords_359f9e79e746fa9f684e5cda9e60ca2e'] = 'Comment ça marche ?';
$_MODULE ['<{sekeywords}prestashop>sekeywords_ec2184245585ba979912af9e34d738c6'] = 'Quand un visiteur arrive sur votre site, le serveur web note l\'adresse du site duquel il vient. Ce module analyse ensuite l\'URL, et s\'il y trouve une référence à une moteur de recherche connu, il y trouvera le mot-clé.';
$_MODULE ['<{sekeywords}prestashop>sekeywords_ef79a74a2fd296e19e8cc58cdae91d43'] = 'Ce module peut reconnaître tous les moteurs de recherche listés dans la page Stats/Moteurs de recherche de PrestaShop -- et vous pouvez en ajouter d\'autres !';
