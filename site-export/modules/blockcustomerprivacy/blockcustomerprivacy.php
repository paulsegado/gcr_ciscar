...
class Blockcustomerprivacy extends Module {
	...
	public function install() {
		$return = (parent::install () && $this->registerHook ( 'createAccountForm' ) && $this->registerHook ( 'displayCustomerIdentityForm' ) && $this->registerHook ( 'actionBeforeSubmitAccount' ));
	...
	public function uninstall() {
		return ($this->unregisterHook ( 'createAccountForm' ) && $this->unregisterHook ( 'displayCustomerIdentityForm' ) && $this->unregisterHook ( 'actionBeforeSubmitAccount' ) && parent::uninstall ());
	}
