...
class BlockManufacturer extends Module {
	...
	public function install() {
		...
		$success = (parent::install () && $this->registerHook ( 'header' ) && $this->registerHook ( 'leftColumn' ) && $this->registerHook ( 'actionObjectManufacturerDeleteAfter' ) && $this->registerHook ( 'actionObjectManufacturerAddAfter' ) && $this->registerHook ( 'actionObjectManufacturerUpdateAfter' ));
		
		return $success;
	}
	public function uninstall() {
		if (! parent::uninstall () || ! Configuration::deleteByName ( 'MANUFACTURER_DISPLAY_TEXT' ) || ! Configuration::deleteByName ( 'MANUFACTURER_DISPLAY_TEXT_NB' ) || ! Configuration::deleteByName ( 'MANUFACTURER_DISPLAY_FORM' ))
			return false;
