	...
	public function hookHeader($params) {
		...
		if (Configuration::get ( 'PS_SEARCH_AJAX' ) || Configuration::get ( 'PS_INSTANT_SEARCH' )) {
			Media::addJsDef ( array (
					'search_url' => $this->context->link->getPageLink ( 'search', Tools::usingSecureMode () ) 
			) );
	...
	public function hookTop($params) {
		...
		if (Tools::getValue ( 'search_query' ) || ! $this->isCached ( 'blocksearch-top.tpl', $key )) {
			...
			$this->smarty->assign ( array (
					...
					'search_query' => ( string ) Tools::getValue ( 'search_query' ),
//<!-- CISCAR Ajout variable pour indiquer si on est en mode visiteur et dans quelle langue-->					
					'visiteur' => $this->context->customer->isLogged (),
