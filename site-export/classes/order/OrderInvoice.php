...
class OrderInvoiceCore extends ObjectModel {
	...
	public static $definition = array (
			...
			'fields' => array (
					...
					'total_discount_tax_excl' => array (
							'type' => self::TYPE_FLOAT 
					),
					'total_discount_tax_incl' => array (
							'type' => self::TYPE_FLOAT 
					),
					...
					'shipping_tax_computation_method' => array (
							'type' => self::TYPE_INT 
					),
	...
	public function useOneAfterAnotherTaxComputationMethod() {
		...
		AND od.`tax_computation_method` = ' . ( int ) TaxCalculator::ONE_AFTER_ANOTHER_METHOD ) || Configuration::get ( 'PS_INVOICE_TAXES_BREAKDOWN' );
	}
	...
	public function getShippingTaxesBreakdown($order) {
		...
		if (Configuration::get ( 'PS_INVOICE_TAXES_BREAKDOWN' ) || Configuration::get ( 'PS_ATCP_SHIPWRAP' )) {
			$shipping_breakdown = Db::getInstance ()->executeS ( 'SELECT t.id_tax, t.rate, oit.amount as total_amount
	...
	public function getSibling() {
		...
		$query->innerJoin ( 'order_invoice_payment', 'oip2', 'oip2.id_order_payment = oip1.id_order_payment AND oip2.id_order_invoice <> oip1.id_order_invoice AND oip1.id_order = oip2.id_order' );
