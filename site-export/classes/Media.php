...
class MediaCore {
	public static $jquery_ui_dependencies = array (
			...
			'ui.widget' => array (
					'fileName' => 'jquery.ui.widget.min.js',
					'dependencies' => array (),
					'theme' => false 
			),
			'ui.mouse' => array (
					'fileName' => 'jquery.ui.mouse.min.js',
					'dependencies' => array (
							'ui.core',
							'ui.widget' 
					),
			...
			'ui.position' => array (
					'fileName' => 'jquery.ui.position.min.js',
					'dependencies' => array (),
					'theme' => false 
			),
			'ui.draggable' => array (
					'fileName' => 'jquery.ui.draggable.min.js',
					'dependencies' => array (
							'ui.core',
							'ui.widget',
							'ui.mouse' 
			...
			'ui.droppable' => array (
					'fileName' => 'jquery.ui.droppable.min.js',
					'dependencies' => array (
							'ui.core',
							'ui.widget',
							'ui.mouse',
			...
			'ui.resizable' => array (
					'fileName' => 'jquery.ui.resizable.min.js',
					'dependencies' => array (
							'ui.core',
							'ui.widget',
							'ui.mouse' 
			...
			'ui.selectable' => array (
					'fileName' => 'jquery.ui.selectable.min.js',
					'dependencies' => array (
							'ui.core',
							'ui.widget',
							'ui.mouse' 
			...
			'ui.sortable' => array (
					'fileName' => 'jquery.ui.sortable.min.js',
					'dependencies' => array (
							'ui.core',
							'ui.widget',
							'ui.mouse' 
			...
			'ui.autocomplete' => array (
					'fileName' => 'jquery.ui.autocomplete.min.js',
					'dependencies' => array (
							'ui.core',
							'ui.widget',
							'ui.position',
			...
			'ui.button' => array (
					'fileName' => 'jquery.ui.button.min.js',
					'dependencies' => array (
							'ui.core',
							'ui.widget' 
					),
			...
			'ui.dialog' => array (
					'fileName' => 'jquery.ui.dialog.min.js',
					'dependencies' => array (
							'ui.core',
							'ui.widget',
							'ui.position',
			...
			'ui.slider' => array (
					'fileName' => 'jquery.ui.slider.min.js',
					'dependencies' => array (
							'ui.core',
							'ui.widget',
							'ui.mouse' 
			...
			'ui.spinner' => array (
					'fileName' => 'jquery.ui.spinner.min.js',
					'dependencies' => array (
							'ui.core',
							'ui.widget',
							'ui.button' 
			...
			'ui.tabs' => array (
					'fileName' => 'jquery.ui.tabs.min.js',
					'dependencies' => array (
							'ui.core',
							'ui.widget' 
					),
			...
			'ui.datepicker' => array (
					'fileName' => 'jquery.ui.datepicker.min.js',
					'dependencies' => array (
							'ui.core' 
					),
					'theme' => true 
			...
			'ui.progressbar' => array (
					'fileName' => 'jquery.ui.progressbar.min.js',
					'dependencies' => array (
							'ui.core',
							'ui.widget' 
					),
			...
			'ui.tooltip' => array (
					'fileName' => 'jquery.ui.tooltip.min.js',
					'dependencies' => array (
							'ui.core',
							'ui.widget',
							'ui.position',
			...
			'ui.accordion' => array (
					'fileName' => 'jquery.ui.accordion.min.js',
					'dependencies' => array (
							'ui.core',
							'ui.widget',
							'effects.core' 
			...
			'effects.core' => array (
					'fileName' => 'jquery.effects.core.min.js',
					'dependencies' => array (),
					'theme' => false 
			),
			'effects.blind' => array (
					'fileName' => 'jquery.effects.blind.min.js',
					'dependencies' => array (
							'effects.core' 
					),
					'theme' => false 
			),
			'effects.bounce' => array (
					'fileName' => 'jquery.effects.bounce.min.js',
					'dependencies' => array (
							'effects.core' 
					),
					'theme' => false 
			...
			'effects.clip' => array (
					'fileName' => 'jquery.effects.clip.min.js',
					'dependencies' => array (
							'effects.core' 
					),
					'theme' => false 
			...
			'effects.drop' => array (
					'fileName' => 'jquery.effects.drop.min.js',
					'dependencies' => array (
							'effects.core' 
					),
					'theme' => false 
			),
			'effects.explode' => array (
					'fileName' => 'jquery.effects.explode.min.js',
					'dependencies' => array (
							'effects.core' 
					),
					'theme' => false 
			...
			'effects.fade' => array (
					'fileName' => 'jquery.effects.fade.min.js',
					'dependencies' => array (
							'effects.core' 
					),
					'theme' => false 
			...
			'effects.fold' => array (
					'fileName' => 'jquery.effects.fold.min.js',
					'dependencies' => array (
							'effects.core' 
					),
					'theme' => false 
			),
			'effects.highlight' => array (
					'fileName' => 'jquery.effects.highlight.min.js',
					'dependencies' => array (
							'effects.core' 
					),
					'theme' => false 
			),
			'effects.pulsate' => array (
					'fileName' => 'jquery.effects.pulsate.min.js',
					'dependencies' => array (
							'effects.core' 
					),
					'theme' => false 
			...
			'effects.scale' => array (
					'fileName' => 'jquery.effects.scale.min.js',
					'dependencies' => array (
							'effects.core' 
					),
					'theme' => false 
			...
			'effects.shake' => array (
					'fileName' => 'jquery.effects.shake.min.js',
					'dependencies' => array (
							'effects.core' 
					),
					'theme' => false 
			...
			'effects.slide' => array (
					'fileName' => 'jquery.effects.slide.min.js',
					'dependencies' => array (
							'effects.core' 
					),
					'theme' => false 
			),
			'effects.transfer' => array (
					'fileName' => 'jquery.effects.transfer.min.js',
					'dependencies' => array (
							'effects.core' 
					),
					'theme' => false 
	...
	public static function minifyHTML($html_content) {
		if (strlen ( $html_content ) > 0) {
			...
			if (trim ( $minified_content = Minify_HTML::minify ( $html_content, array (
					'cssMinifier',
					'jsMinifier' 
			) ) ) != '') {
	...
	public static function packJSinHTML($html_content) {
		if (strlen ( $html_content ) > 0) {
			...
			if (! preg_match ( '/' . Media::$pattern_keepinline . '/', $html_content )) {
				$html_content = preg_replace_callback ( Media::$pattern_js, array (
						'Media',
						'packJSinHTMLpregCallback' 
				), $html_content, Media::getBackTrackLimit () );
	...
	public static function minifyCSS($css_content, $fileuri = false, &$import_url = array()) {
		...
		if (strlen ( $css_content ) > 0) {
			...
			$css_content = preg_replace_callback ( Media::$pattern_callback, array (
					'Media',
			...
			$css_content = preg_replace_callback ( '#(AlphaImageLoader\(src=\')([^\']*\',)#s', array (
					'Tools',
					'replaceByAbsoluteURL' 
			), $css_content );
	...
	public static function getMediaPath($media_uri, $css_media_type = null) {
		...
		if (! array_key_exists ( 'host', $url_data )) {
			$media_uri_host_mode = '/' . ltrim ( str_replace ( str_replace ( array (
					'/',
					'\\' 
			), DIRECTORY_SEPARATOR, _PS_CORE_DIR_ ), __PS_BASE_URI__, $media_uri ), '/\\' );
			$media_uri = '/' . ltrim ( str_replace ( str_replace ( array (
					'/',
					'\\' 
			), DIRECTORY_SEPARATOR, _PS_ROOT_DIR_ ), __PS_BASE_URI__, $media_uri ), '/\\' );
...
elseif (preg_match ( '/^([0-9\.]+)$/Ui', $version )) {
	...
	public static function cccCss($css_files, $cache_path = null) {
		...
		foreach ( $css_files as $filename => $media ) {
			...
			if (! array_key_exists ( $media, $compressed_css_files_infos )) {
				$compressed_css_files_infos [$media] = array (
						'key' => '' 
				);
			}
	...
	public static function ieCssSplitter($compiled_css, $cache_path, $refresh = false) {
		...
		// return cached css
		if (! $refresh) {
			foreach ( array_diff ( scandir ( $cache_path ), array (
					'..',
					'.' 
			) ) as $file ) {
	...
	public static function cccJS($js_files) {
		...
		return array_merge ( array (
				$protocol_link . Tools::getMediaServer ( $url ) . $url 
		), $js_external_files );
	}
	...
	public static function deferInlineScripts($output) {
		...
		$output = preg_replace_callback ( Media::$pattern_js, array (
				'Media',
				'deferScript' 
		), $output );
		return $output;
