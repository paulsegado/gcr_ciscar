...
class AddressCore extends ObjectModel {
	 ...
	 * @var string DNI number
	 */
//<!-- CISCAR ajout de la reference Client Sage -->
	public $ref_cli_sage;
...
//<!-- CISCAR on rend le champ société obligatoire -->
					'company' => array (
							'type' => self::TYPE_STRING,
							'validate' => 'isGenericName',
							'required' => true,
...
//<!-- CISCAR ajout de la reference Client Sage -->
	...
	public static function getZoneById($id_address) {
		...
		$id_zone = Hook::exec ( 'actionGetIDZoneByAddressID', array (
