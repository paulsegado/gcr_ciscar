...
class FeatureValueCore extends ObjectModel {
	...
	public function add($autodate = true, $nullValues = false) {
		...
		if ($return) {
			Hook::exec ( 'actionFeatureValueSave', array (
					'id_feature_value' => $this->id 
			) );
		}
		return $return;
	}
	public function delete() {
		...
		if ($return) {
			Hook::exec ( 'actionFeatureValueDelete', array (
					'id_feature_value' => $this->id 
			) );
		}
		return $return;
