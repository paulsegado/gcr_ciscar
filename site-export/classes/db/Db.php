...
abstract class DbCore {
	...
	/**
	 * @var string Server (eg.
	 * localhost)
	 */
	protected $server;
	
	/**
	 * @var string Database user (eg.
	 * root)
	 */
	protected $user;
	
	/**
	 * @var string Database password (eg.
	 * can be empty !)
	 */
	protected $password;
	 ...
	 *        	Database name
	 * @param bool $connect
	 *        	If false, don't connect in constructor (since 1.5.0.1)
	 */
	 ...
	 * @param array $data        	
	 * @param string $type
	 *        	(INSERT, INSERT IGNORE, REPLACE, UPDATE).
	 * @param string $where        	
	 * @param int $limit        	
	 ...
	 *        	Add or not _DB_PREFIX_ before table name
	 * @return bool
	 * @throws PrestaShopDatabaseException
	 */
	 ...
	 *        	Query to execute
	 * @param bool $array
	 *        	Return an array instead of a result object (deprecated since 1.5.0.1, use query method instead)
	 * @param bool $use_cache        	
