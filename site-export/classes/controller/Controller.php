...
abstract class ControllerCore {
	 ...
	 * Possible values: 'front', 'modulefront', 'admin', 'moduleadmin'
	 */
	 ...
	 *
	 * @param string|array $css_uri
	 *        	Path to CSS file or an array like: array(array(uri => media_type), ...)
	 * @param string $css_media_type        	
	 * @param bool $check_path        	
	 */
	 ...
	 *        	Path to JS file or an array like: array(uri, ...)
	 * @param bool $check_path        	
	 * @return void
	 */
	 ...
	 *        	jQuery file folder
	 * @param bool $minifier
	 *        	If set tot true, a minified version will be included.
	 */
	 ...
	 *        	Template file(s) to be rendered
	 * @throws Exception
	...
	protected function smartyOutputContent($content) {
		...
		if (in_array ( $this->controller_type, array (
				'front',
				'modulefront' 
		) ) && ! empty ( $html ) && $this->getLayout ()) {
			$live_edit_content = '';
	...
	protected function ajaxDie($value = null, $controller = null, $method = null) {
		...
		Hook::exec ( 'actionBeforeAjaxDie', array (
				'controller' => $controller,
				'method' => $method,
				'value' => $value 
		) );
		Hook::exec ( 'actionBeforeAjaxDie' . $controller . $method, array (
				'value' => $value 
		) );
