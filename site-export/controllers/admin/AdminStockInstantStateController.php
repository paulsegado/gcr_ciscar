...
class AdminStockInstantStateControllerCore extends AdminController {
	...
	public function __construct() {
		...
		array_unshift ( $this->stock_instant_state_warehouses, array (
				'id_warehouse' => - 1,
	...
	public function getList($id_lang, $order_by = null, $order_way = null, $start = 0, $limit = null, $id_lang_shop = false) {
		if (Tools::isSubmit ( 'id_stock' )) {
			...
			for($i = 0; $i < $nb_items; $i ++) {
				...
				$item ['real_quantity'] = $manager->getProductRealQuantities ( $item ['id_product'], $item ['id_product_attribute'], ($this->getCurrentCoverageWarehouse () == - 1 ? null : array (
