	...
	public function __construct() {
		...
		$this->fields_list = array (
				...
				'conversion_rate' => array (
						...
						'width' => 130,
						'search' => false,
						'filter_key' => 'currency_shop!conversion_rate' 
				),
				'active' => array (
						...
						array (
								...
								'options' => array (
										'query' => array (
												array (
														'key' => 1,
														'name' => 'X0,000.00 (' . $this->l ( 'Such as with Dollars' ) . ')' 
												),
												array (
														'key' => 2,
														'name' => '0 000,00X (' . $this->l ( 'Such as with Euros' ) . ')' 
												),
												array (
														'key' => 3,
														'name' => 'X0.000,00' 
										...
										) // Added for the switzerland currency
,
										'name' => 'name',
										'id' => 'key' 
								) 
