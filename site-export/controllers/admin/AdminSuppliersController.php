		...
		$this->fields_form = array (
				...
				'input' => array (
						...
						array (
								...
								'autoload_rte' => 'rte' 
						) // Enable TinyMCE editor for short description
,
						array (
								'type' => 'text',
								'label' => $this->l ( 'Phone' ),
	...
	protected function afterImageUpload() {
		...
		if (($id_supplier = ( int ) Tools::getValue ( 'id_supplier' )) && isset ( $_FILES ) && count ( $_FILES ) && file_exists ( _PS_SUPP_IMG_DIR_ . $id_supplier . '.jpg' )) {
