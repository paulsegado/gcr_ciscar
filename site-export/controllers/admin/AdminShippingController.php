...
class AdminShippingControllerCore extends AdminController {
	...
	public function __construct() {
		...
		$carrier_default_sort = array (
				array (
						'value' => Carrier::SORT_BY_PRICE,
						'name' => $this->l ( 'Price' ) 
				),
				array (
						'value' => Carrier::SORT_BY_POSITION,
		...
		$carrier_default_order = array (
				array (
						'value' => Carrier::SORT_BY_ASC,
						'name' => $this->l ( 'Ascending' ) 
				),
				array (
						'value' => Carrier::SORT_BY_DESC,
						...
						'fields' => array (
								'PS_CARRIER_DEFAULT' => array (
										...
										'list' => array_merge ( array (
												- 1 => array (
														'id_carrier' => - 1,
														'name' => $this->l ( 'Best price' ) 
												),
												- 2 => array (
														'id_carrier' => - 2,
														'name' => $this->l ( 'Best grade' ) 
												) 
