...
class AdminStatusesControllerCore extends AdminController {
	...
	public function renderList() {
		...
		foreach ( $buf as $row )
			$unremovable_os [] = $row ['id_order_state'];
						...
						array (
								...
								'values' => array (
										'query' => array (
												array (
														'id' => 'on',
														'name' => $this->l ( 'Allow a customer to download and view PDF versions of his/her invoices.' ),
														'val' => '1' 
												) 
										),
										'id' => 'id',
						...
						array (
								...
								'values' => array (
										'query' => array (
												array (
														'id' => 'on',
														'name' => $this->l ( 'Hide this status in all customer orders.' ),
														'val' => '1' 
												) 
										),
										'id' => 'id',
						...
						array (
								...
								'values' => array (
										'query' => array (
												array (
														'id' => 'on',
														'name' => $this->l ( 'Send an email to the customer when his/her order status has changed.' ),
														'val' => '1' 
												) 
										),
										'id' => 'id',
						...
						array (
								...
								'values' => array (
										'query' => array (
												array (
														'id' => 'on',
														'name' => $this->l ( 'Attach invoice PDF to email.' ),
														'val' => '1' 
												) 
										),
										'id' => 'id',
						...
						array (
								...
								'values' => array (
										'query' => array (
												array (
														'id' => 'on',
														'name' => $this->l ( 'Attach delivery slip PDF to email.' ),
														'val' => '1' 
												) 
										),
										'id' => 'id',
						...
						array (
								...
								'values' => array (
										'query' => array (
												array (
														'id' => 'on',
														'name' => $this->l ( 'Set the order as shipped.' ),
														'val' => '1' 
												) 
										),
										'id' => 'id',
						...
						array (
								...
								'values' => array (
										'query' => array (
												array (
														'id' => 'on',
														'name' => $this->l ( 'Set the order as paid.' ),
														'val' => '1' 
												) 
										),
										'id' => 'id',
	...
	protected function afterImageUpload() {
		...
		if (($id_order_state = ( int ) Tools::getValue ( 'id_order_state' )) && isset ( $_FILES ) && count ( $_FILES ) && file_exists ( _PS_ORDER_STATE_IMG_DIR_ . $id_order_state . '.gif' )) {
