...
class AdminLocalizationControllerCore extends AdminController {
				...
				'general' => array (
						...
						'fields' => array (
								...
								'PS_CURRENCY_DEFAULT' => array (
										...
										'hint' => $this->l ( 'The default currency used in your shop.' ) . ' - ' . $this->l ( 'If you change the default currency, you will have to manually edit every product price.' ),
										'cast' => 'intval',
										'type' => 'select',
	...
	public function renderForm() {
		...
		usort ( $localizations_pack, array (
				$this,
	...
	public function updateOptionPsCurrencyDefault($value) {
		...
		ObjectModel::updateMultishopTable ( 'Currency', array (
				'conversion_rate' => 1 
		), 'a.id_currency' );
