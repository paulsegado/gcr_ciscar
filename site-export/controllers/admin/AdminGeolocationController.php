	...
	public function __construct() {
		...
		$this->fields_options = array (
				...
				'geolocationCountries' => array (
						...
						'fields' => array (
								'PS_GEOLOCATION_BEHAVIOR' => array (
										...
										'list' => array (
												array (
														'key' => _PS_GEOLOCATION_NO_CATALOG_,
														'name' => $this->l ( 'Visitors cannot see your catalog.' ) 
												),
												array (
														'key' => _PS_GEOLOCATION_NO_ORDER_,
														'name' => $this->l ( 'Visitors can see your catalog but cannot place an order.' ) 
												) 
										) 
								),
								'PS_GEOLOCATION_NA_BEHAVIOR' => array (
										...
										'list' => array (
												array (
														'key' => '-1',
														'name' => $this->l ( 'All features are available' ) 
												),
												array (
														'key' => _PS_GEOLOCATION_NO_CATALOG_,
														'name' => $this->l ( 'Visitors cannot see your catalog.' ) 
				...
				'geolocationWhitelist' => array (
						...
						'fields' => array (
								'PS_GEOLOCATION_WHITELIST' => array (
										'title' => $this->l ( 'Whitelisted IP addresses' ),
										'type' => 'textarea_newlines',
										'cols' => 15,
										'rows' => 30 
								) 
						),
