...
class CategoryControllerCore extends FrontController {
	...
	public function canonicalRedirection($canonical_url = '') {
		...
		if (! Validate::isLoadedObject ( $this->category ) || ! $this->category->inShop () || ! $this->category->isAssociatedToShop () || in_array ( $this->category->id, array (
	...
	public function initContent() {
		...
		$this->context->smarty->assign ( array (
				...
				'body_classes' => array (
						$this->php_self . '-' . $this->category->id,
						$this->php_self . '-' . $this->category->link_rewrite 
				) 
		) );
	}
