...
class OrderControllerCore extends ParentOrderController {
	...
	public function initContent() {
		...
		switch (( int ) $this->step) {
			...
			case OrderController::STEP_PAYMENT :
				...
				//<!-- CISCAR  variable pour masquer le moyen de paiement -->
	...
	protected function _assignPayment() {
		...
		Hook::exec ( 'displayBeforePayment', array (
				'module' => 'order.php?step=3' 
		) );
		...
		$this->context->smarty->assign ( array (
		'option_list_delivery' => $this->context->cart->getDeliveryOptionList ()));
