<?php /* Smarty version Smarty-3.1.19, created on 2019-02-05 16:23:22
         compiled from "C:\wamp64\www\workspace\www\site-export\themes\default-bootstrap\order-steps.tpl" */ ?>
<?php /*%%SmartyHeaderCode:318315c59aa6aa2af47-30002776%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1a5292b034563092112725ffffbca4fb1fc053bc' => 
    array (
      0 => 'C:\\wamp64\\www\\workspace\\www\\site-export\\themes\\default-bootstrap\\order-steps.tpl',
      1 => 1505149354,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '318315c59aa6aa2af47-30002776',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c59aa6abed534_97353355',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c59aa6abed534_97353355')) {function content_5c59aa6abed534_97353355($_smarty_tpl) {?>
...
">
			<em>02.</em> <?php echo smartyTranslate(array('s'=>'Address'),$_smarty_tpl);?>

		</a>
		<?php } else { ?>
			<span><em>02.</em> <?php echo smartyTranslate(array('s'=>'Address'),$_smarty_tpl);?>
</span>
		<?php }?>
	</li>
	<li class="<?php if ($_smarty_tpl->tpl_vars['current_step']->value=='shipping') {?>step_current<?php } else { ?><?php if ($_smarty_tpl->tpl_vars['current_step']->value=='payment') {?>step_done step_done_last<?php } else { ?>step_todo<?php }?><?php }?> third">
...
">
			<em>03.</em> <?php echo smartyTranslate(array('s'=>'Shipping'),$_smarty_tpl);?>

		</a>
		<?php } else { ?>
			<span><em>03.</em> <?php echo smartyTranslate(array('s'=>'Shipping'),$_smarty_tpl);?>
</span>
		<?php }?>
	</li>
	<li id="step_end" class="<?php if ($_smarty_tpl->tpl_vars['current_step']->value=='payment') {?>step_current<?php } else { ?>step_todo<?php }?> last">
		<span><em>04.</em> <?php echo smartyTranslate(array('s'=>'Payment'),$_smarty_tpl);?>
</span>
	</li>
</ul>
<!-- /Steps -->
