<?php /* Smarty version Smarty-3.1.19, created on 2019-06-21 18:25:08
         compiled from "C:\wamp64\www\workspace\www\site-export\themes\default-bootstrap\authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:36245c3f52bb4337b9-89770319%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '33ba41b261250b6eec304f806046a64ec48a124a' => 
    array (
      0 => 'C:\\wamp64\\www\\workspace\\www\\site-export\\themes\\default-bootstrap\\authentication.tpl',
      1 => 1557221417,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '36245c3f52bb4337b9-89770319',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5c3f52bc38fce2_22117332',
  'variables' => 
  array (
    'email_create' => 0,
    'link' => 0,
...
<?php if ($_valid && !is_callable('content_5c3f52bc38fce2_22117332')) {function content_5c3f52bc38fce2_22117332($_smarty_tpl) {?>
...
?>
	...
	<?php }?>-->
	<div class="row">
		<div class="col-xs-12 col-sm-1 <?php if ($_smarty_tpl->tpl_vars['autologin']->value=='O') {?>col-lg-4 col-md-4<?php } else { ?>col-lg-2 col-md-2<?php }?> "></div>
...
" method="post" id="login_form" class="box">
				<?php if ($_smarty_tpl->tpl_vars['autologin']->value=='O') {?>
					<h3 class="page-subheading"><?php echo smartyTranslate(array('s'=>'Current connexion'),$_smarty_tpl);?>
</h3>
				<?php } else { ?>
...
<!-- CISCAR Mise en form du formulaire de connexion automatique si on vient du site Belge ou Néerlandais-->				
					<?php if ($_smarty_tpl->tpl_vars['autologin']->value=='O') {?>
						...
						<p><span><?php echo $_smarty_tpl->tpl_vars['login_mail']->value;?>
</span</p>
						<input type="hidden" class="is_required validate account_input form-control" data-validate="isEmail" type="email" id="email" name="email" value="<?php if (isset($_POST['email'])) {?><?php echo stripslashes($_POST['email']);?>
<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['login_mail']->value;?>
<?php }?>" />
						<input type="hidden" class="is_required validate account_input form-control" type="password" data-validate="isPasswd" id="passwd" name="passwd" value="<?php echo $_smarty_tpl->tpl_vars['login_pwd']->value;?>
" />
						<input type="hidden" class="is_required validate account_input form-control" id="product" name="product" value="<?php echo $_smarty_tpl->tpl_vars['id_product']->value;?>
" />
						<input type="hidden" class="is_required validate account_input form-control" id="category" name="category" value="<?php echo $_smarty_tpl->tpl_vars['id_category']->value;?>
" />
						<input type="hidden" class="is_required validate account_input form-control" id="cms" name="cms" value="<?php echo $_smarty_tpl->tpl_vars['id_cms']->value;?>
" />
						<input type="hidden" class="is_required validate account_input form-control" id="cms_category" name="cms_category" value="<?php echo $_smarty_tpl->tpl_vars['id_cms_category']->value;?>
" />
...
<?php }?>" />
						...
						<input class="is_required validate account_input form-control" type="password" data-validate="isPasswd" id="passwd" name="passwd" value="<?php echo $_smarty_tpl->tpl_vars['login_pwd']->value;?>
" />
						</div>
...
<!-- CISCAR Le bouton est masqué sur le formulaire de connexion automatique -->						
					<p class="submit" style="text-align:right;<?php if ($_smarty_tpl->tpl_vars['autologin']->value=='O') {?> display:none;<?php }?>">
...
<!-- CISCAR Le formulaire "Creez votre compte" est masqué si connexion automatique -->			
		<div class="col-xs-12 col-sm-5 col-lg-4 col-md-4 " <?php if ($_smarty_tpl->tpl_vars['autologin']->value=='O') {?> style="display:none;"<?php }?>>
			<form action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true), ENT_QUOTES, 'UTF-8', true);?>
...
" method="post" id="account-creation_form" class="std box">
		...
		<div class="account_creation">
			...
			<label><?php echo smartyTranslate(array('s'=>'Site CISCAR est réservé aux professionnels automobile : concessionnaires, agents, garages indépendants, centres de formation, etc...'),$_smarty_tpl);?>
</label>
			<p class="required"><sup>*</sup><?php echo smartyTranslate(array('s'=>'Required field'),$_smarty_tpl);?>
</p>
			<div class="clearfix">
...
" <?php if (isset($_POST['id_gender'])&&$_POST['id_gender']==$_smarty_tpl->tpl_vars['gender']->value->id) {?>checked="checked"<?php }?> />
 ...
 <sup>*</sup></label>
				<input onchange="$('#firstname').val(this.value);" type="text" class="is_required validate form-control" data-validate="isName" id="customer_firstname" name="customer_firstname" value="<?php if (isset($_POST['customer_firstname'])) {?><?php echo $_POST['customer_firstname'];?>
<?php }?>" />
			</div>
			<div class="required form-group">
				<label for="customer_lastname"><?php echo smartyTranslate(array('s'=>'Last name'),$_smarty_tpl);?>
 <sup>*</sup></label>
				<input onchange="$('#lastname').val(this.value);" type="text" class="is_required validate form-control" data-validate="isName" id="customer_lastname" name="customer_lastname" value="<?php if (isset($_POST['customer_lastname'])) {?><?php echo $_POST['customer_lastname'];?>
<?php }?>" />
			</div>
			<div class="required form-group">
...
<!-- CISCAR La societe est pre remplie dans le champ titre de l'adresse (id=alias) -->					
					<input onchange="$('#alias').val(this.value);" type="text" class="is_required validate form-control" data-validate="isGenericName" id="company" name="company" value="<?php if (isset($_POST['company'])) {?><?php echo $_POST['company'];?>
<?php }?>" />
				</p>
<!-- CISCAR on remplace SIRET par VAT -->	
				<p class="form-group">
					<label for="siret"><?php echo smartyTranslate(array('s'=>'VAT'),$_smarty_tpl);?>
 <sup>*</sup></label>
...
<!-- CISCAR on remplace APE par Function -->	
				<p class="form-group">
					<label for="ape"><?php echo smartyTranslate(array('s'=>'Function'),$_smarty_tpl);?>
</label>
...
<!-- CISCAR on remplace Website par Mark -->	
				<p class="form-group">
					<label for="website"><?php echo smartyTranslate(array('s'=>'Mark'),$_smarty_tpl);?>
</label>
...
<!-- CISCAR on met en hidden le champ prenom	-->	
							<label style="display:none;" for="firstname"><?php echo smartyTranslate(array('s'=>'First name'),$_smarty_tpl);?>
 <sup>*</sup></label>					
							<input type="hidden" class="form-control" id="firstname" name="firstname" value="<?php if (isset($_POST['firstname'])) {?><?php echo $_POST['firstname'];?>
<?php }?>" />
						</p>
					<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="lastname") {?>
						<p class="required form-group">
<!-- CISCAR on met en hidden le champ nom	-->	
							<label style="display:none;" for="lastname"><?php echo smartyTranslate(array('s'=>'Last name'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<input type="hidden" class="form-control" id="lastname" name="lastname" value="<?php if (isset($_POST['lastname'])) {?><?php echo $_POST['lastname'];?>
<?php }?>" />
						</p>
					<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="address1") {?>
						<p class="required form-group">
...
<!-- CISCAR, on masque le champ telephone mobile --> 				
				<p style="display:none;" class="<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?>required <?php }?>form-group">
					<label for="phone_mobile"><?php echo smartyTranslate(array('s'=>'Mobile phone'),$_smarty_tpl);?>
<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?> <sup>**</sup><?php }?></label>
					<input type="text" class="form-control" name="phone_mobile" id="phone_mobile" value="<?php if (isset($_POST['phone_mobile'])) {?><?php echo $_POST['phone_mobile'];?>
<?php }?>" />
...
<!-- CISCAR, on met en hidden le champ alias --> 
					<label style="display:none;" for="alias"><?php echo smartyTranslate(array('s'=>'Assign an address alias for future reference.'),$_smarty_tpl);?>
 <sup>*</sup></label>
					<input type="hidden" class="form-control" name="alias" id="alias" value="<?php if (isset($_POST['alias'])) {?><?php echo $_POST['alias'];?>
