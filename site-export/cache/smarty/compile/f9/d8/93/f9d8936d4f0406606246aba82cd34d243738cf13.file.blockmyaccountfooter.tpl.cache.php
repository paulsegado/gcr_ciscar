<?php /* Smarty version Smarty-3.1.19, created on 2019-02-05 16:23:07
         compiled from "C:\wamp64\www\workspace\www\site-export\themes\default-bootstrap\modules\blockmyaccountfooter\blockmyaccountfooter.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5c59aa5ba917d2_50072195',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c59aa5ba917d2_50072195')) {function content_5c59aa5ba917d2_50072195($_smarty_tpl) {?>
...
" rel="nofollow"><?php echo smartyTranslate(array('s'=>'My orders','mod'=>'blockmyaccountfooter'),$_smarty_tpl);?>
			...
			<?php if ($_smarty_tpl->tpl_vars['returnAllowed']->value) {?><li style="display:none;"><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-follow',true), ENT_QUOTES, 'UTF-8', true);?>
...
" rel="nofollow"><?php echo smartyTranslate(array('s'=>'My personal info','mod'=>'blockmyaccountfooter'),$_smarty_tpl);?>
			...
			<?php if ($_smarty_tpl->tpl_vars['voucherAllowed']->value) {?><li style="display:none;"><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('discount',true), ENT_QUOTES, 'UTF-8', true);?>
