<?php /* Smarty version Smarty-3.1.19, created on 2019-02-05 16:23:21
         compiled from "C:\wamp64\www\workspace\www\site-export\themes\default-bootstrap\shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:45665c59aa69bf72d0-30458460%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cda8b903f256eb353cad84b4af080dc692938b40' => 
    array (
      0 => 'C:\\wamp64\\www\\workspace\\www\\site-export\\themes\\default-bootstrap\\shopping-cart.tpl',
      1 => 1528788962,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '45665c59aa69bf72d0-30458460',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c59aa6aa0b128_52456308',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c59aa6aa0b128_52456308')) {function content_5c59aa6aa0b128_52456308($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include 'C:\\wamp64\\www\\workspace\\www\\site-export\\tools\\smarty\\plugins\\modifier.regex_replace.php';
?>
...
<!-- CISCAR suppression bordure tableau
			...
			<tfoot>
				...
				<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value) {?>
					<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value) {?>
						<tr class="cart_total_price"  style="background:transparent;">
...
-->							
							<td colspan="3" style="border-bottom: 0px solid #d6d4d4;"></td>
						</tr>
					<?php } else { ?>
...
<?php }?>
				...
				<?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0&&(!isset($_smarty_tpl->tpl_vars['isVirtualCart']->value)||!$_smarty_tpl->tpl_vars['isVirtualCart']->value)&&$_smarty_tpl->tpl_vars['free_ship']->value) {?>
<!-- CISCAR suppression Frais de livraison
...
" class="text-right"><?php echo smartyTranslate(array('s'=>'Total shipping'),$_smarty_tpl);?>
				...
				<tr class="cart_total_voucher<?php if ($_smarty_tpl->tpl_vars['total_discounts']->value==0) {?> unvisible<?php }?>">
					<td colspan="<?php echo $_smarty_tpl->tpl_vars['col_span_subtotal']->value;?>
" class="text-right" style="border-top:0px;">
					...
					<td colspan="2" class="price-discount price" id="total_discount" style="border-top:0px;">
						<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&$_smarty_tpl->tpl_vars['priceDisplay']->value==0) {?>
...
" class="text-right"><?php echo smartyTranslate(array('s'=>'Tax'),$_smarty_tpl);?>
				...
				<tr class="cart_total_price" style="background:transparent;">
					<td colspan="<?php echo $_smarty_tpl->tpl_vars['col_span_subtotal']->value;?>
" class="total_price_container text-right" style="border-top: 0px solid #d6d4d4;border-right: 0px solid #d6d4d4;background:transparent;padding-left:0px;margin-left:0px">
						<span><?php echo smartyTranslate(array('s'=>'Total ex VAT'),$_smarty_tpl);?>
</span>
					...
					<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value) {?>
						<td colspan="2" class="price" id="total_price_container" style="border-top: 0px solid #d6d4d4;border-left: 0px solid #d6d4d4;background:transparent;">
...
$_smarty_tpl->tpl_vars['addresses_style']->value['alias'] = 'address_title';?>
	...
	<?php if (!$_smarty_tpl->tpl_vars['advanced_payment_api']->value&&((!empty($_smarty_tpl->tpl_vars['delivery_option']->value)&&(!isset($_smarty_tpl->tpl_vars['isVirtualCart']->value)||!$_smarty_tpl->tpl_vars['isVirtualCart']->value))||$_smarty_tpl->tpl_vars['delivery']->value->id||$_smarty_tpl->tpl_vars['invoice']->value->id)&&!$_smarty_tpl->tpl_vars['opc']->value) {?>
		<div class="order_delivery clearfix row" style="display:none;">
