<?php /* Smarty version Smarty-3.1.19, created on 2019-02-05 16:23:15
         compiled from "C:\wamp64\www\workspace\www\site-export\themes\default-bootstrap\product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:53225c59aa6364c175-13446624%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '58819041d5956cf44d08280fff4c8a48bb4ddb24' => 
    array (
      0 => 'C:\\wamp64\\www\\workspace\\www\\site-export\\themes\\default-bootstrap\\product.tpl',
      1 => 1544091546,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '53225c59aa6364c175-13446624',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c59aa64cb50f2_05477898',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c59aa64cb50f2_05477898')) {function content_5c59aa64cb50f2_05477898($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\wamp64\\www\\workspace\\www\\site-export\\tools\\smarty\\plugins\\modifier.date_format.php';
if (!is_callable('smarty_function_math')) include 'C:\\wamp64\\www\\workspace\\www\\site-export\\tools\\smarty\\plugins\\function.math.php';
if (!is_callable('smarty_function_cycle')) include 'C:\\wamp64\\www\\workspace\\www\\site-export\\tools\\smarty\\plugins\\function.cycle.php';
if (!is_callable('smarty_function_counter')) include 'C:\\wamp64\\www\\workspace\\www\\site-export\\tools\\smarty\\plugins\\function.counter.php';
?>
...
<!-- CISCAR , On rend cette div invisible si le produit n'est pas disponible à la vente dans le back office 	-->					
					<div class="box-info-product" <?php if (!$_smarty_tpl->tpl_vars['product']->value->available_for_order) {?> style="display:none;" <?php }?>>
					<div class="content_prices clearfix">
						<?php if ($_smarty_tpl->tpl_vars['product']->value->show_price&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
							<!-- prices -->
							<div>
								<p class="our_price_display" itemprop="offers" itemscope itemtype="https://schema.org/Offer"><?php if ($_smarty_tpl->tpl_vars['product']->value->quantity>0) {?><link itemprop="availability" href="https://schema.org/InStock"/><?php }?><?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value>=0&&$_smarty_tpl->tpl_vars['priceDisplay']->value<=2) {?><!-- CISCAR 3, ajouter le prix unitaire si renseigne 	--><?php if ($_smarty_tpl->tpl_vars['product']->value->unit_price_ratio>0.000000) {?><?php echo smarty_function_math(array('equation'=>"pprice / punit_price",'pprice'=>$_smarty_tpl->tpl_vars['productPrice']->value,'punit_price'=>$_smarty_tpl->tpl_vars['product']->value->unit_price_ratio,'assign'=>'unit_price'),$_smarty_tpl);?>
<span class="price" itemprop="price" id="unit_price_display"><?php echo $_smarty_tpl->tpl_vars['unit_price']->value;?>
</span><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"displayProductPriceBlock",'product'=>$_smarty_tpl->tpl_vars['product']->value,'type'=>"unit_price"),$_smarty_tpl);?>
<?php } else { ?><span id="our_price_display" class="price" itemprop="price" content="<?php echo $_smarty_tpl->tpl_vars['productPrice']->value;?>
...
</span><?php }?><!-- FIN ajouter le prix unitaire --><?php if ($_smarty_tpl->tpl_vars['tax_enabled']->value&&((isset($_smarty_tpl->tpl_vars['display_tax_label']->value)&&$_smarty_tpl->tpl_vars['display_tax_label']->value==1)||!isset($_smarty_tpl->tpl_vars['display_tax_label']->value))) {?><?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value==1) {?> <?php echo smartyTranslate(array('s'=>'tax excl.'),$_smarty_tpl);?>
 <?php } else { ?> <?php echo smartyTranslate(array('s'=>'tax incl.'),$_smarty_tpl);?>
 <?php }?><?php }?><!-- CISCAR, ajouter l'expression "le lot" si le prix unitaire est renseigne 	--><?php if ($_smarty_tpl->tpl_vars['product']->value->unit_price_ratio>0.000000) {?><?php echo smartyTranslate(array('s'=>'The unit'),$_smarty_tpl);?>
<?php }?><meta itemprop="priceCurrency" content="<?php echo $_smarty_tpl->tpl_vars['currency']->value->iso_code;?>
...
<?php }?></span> <?php echo smartyTranslate(array('s'=>'for ecotax'),$_smarty_tpl);?>
							...
							<?php }?>
<!-- CISCAR, ajouter le prix du lot si renseigne prix unitaire renseigne 	-->	
							<?php if ($_smarty_tpl->tpl_vars['product']->value->unit_price_ratio>0.000000) {?>
								<p class="unit-price"><span id="our_unit_price_display"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>floatval($_smarty_tpl->tpl_vars['productPrice']->value)),$_smarty_tpl);?>
</span> <?php echo smartyTranslate(array('s'=>'package'),$_smarty_tpl);?>
 </p>
								<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"displayProductPriceBlock",'product'=>$_smarty_tpl->tpl_vars['product']->value,'type'=>"unit_price"),$_smarty_tpl);?>

							<?php }?>
<!-- CISCAR, on supprime l'affichage du lot  							
								...
								<p class="unit-price"><span id="unit_price_display"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>floatval($_smarty_tpl->tpl_vars['productPrice']->value)),$_smarty_tpl);?>
...
<!-- CISCAR, la quantite n'es plus modifiable 	
