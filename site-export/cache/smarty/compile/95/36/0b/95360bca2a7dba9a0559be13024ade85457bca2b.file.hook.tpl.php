<?php /* Smarty version Smarty-3.1.19, created on 2018-10-15 12:26:21
         compiled from "C:\wamp64\www\workspace\www\site-export\modules\themeconfigurator\views\templates\hook\hook.tpl" */ ?>
<?php /*%%SmartyHeaderCode:236225bc46b4d700da0-22595057%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '95360bca2a7dba9a0559be13024ade85457bca2b' => 
    array (
      0 => 'C:\\wamp64\\www\\workspace\\www\\site-export\\modules\\themeconfigurator\\views\\templates\\hook\\hook.tpl',
      1 => 1537282605,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '236225bc46b4d700da0-22595057',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bc46b4d835d30_45314546',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bc46b4d835d30_45314546')) {function content_5bc46b4d835d30_45314546($_smarty_tpl) {?>
			...
			<?php }?>
					<?php if ($_smarty_tpl->tpl_vars['hItem']->value['url']) {?>
						<?php if ($_smarty_tpl->tpl_vars['id_client']->value==0) {?>
							<a href="index.php?controller=authentication" class="item-link" title="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['hItem']->value['title'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
">
						<?php } else { ?>
...
<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['id_client']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&idLang=<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['iso_language']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
