...
if (! class_exists ( 'PEAR', false )) {
	...
	class PEAR {
		...
		/**
		 * Constructor.
		 * Registers this object in
		 * $_PEAR_destructor_object_list for destructor emulation if a
		 * destructor object exists.
		 *
		 * @param string $error_class
		 *        	(optional) which class to use for
		 ...
		 *        	the value to test
		 * @param int $code
		 *        	if $data is an error object, return true
		 ...
		 *        	
		 * @param int $code
		 *        	a numeric error code (it is up to your class
		 ...
		 *        	
		 * @param mixed $options
		 *        	If $mode is PEAR_ERROR_TRIGGER, this parameter
		 ...
		 *        	If you need to pass along for example debug
		 *        	information, this parameter is meant for that.
		 *        	
		 * @param string $error_class
		 *        	The returned error object will be
		 *        	instantiated from this class, if specified.
		 *        	
		 * @param bool $skipmsg
		 *        	If true, raiseError will only pass error codes,
...
if (! class_exists ( 'PEAR_Error', false )) {
	class PEAR_Error {
		 ...
		 *        	
		 * @param mixed $options
		 *        	(optional) error level, _OR_ in the case of
...
if (! class_exists ( 'PEAR_Exception', false )) {
	class PEAR_Exception extends Exception {
		 ...
		 *        	- A valid php callback, see php func is_callable()
		 *        	- A PEAR_Exception::OBSERVER_* constant
		 *        	- An array(const PEAR_Exception::OBSERVER_*,
		 *        	mixed $options)
		 * @param string $label
		 *        	The name of the observer. Use this if you want
