...
/**
 * This class provides support for RSS 2.0 entries.
 * It will usually be
...
class XML_Feed_Parser_RSS2Element extends XML_Feed_Parser_RSS2 {
	 ...
	 * @param XML_Feed_Parser_RSS2 $parent
	...
	protected function getGuid($method, $params) {
		$attribute = (isset ( $params [0] ) and $params [0] == 'ispermalink') ? true : false;
	 ...
	 *        	- we expect the first of these to be our offset
	 * @return array|false
	 */
