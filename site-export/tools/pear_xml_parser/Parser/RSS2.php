 ...
 * @version CVS: $Id: RSS2.php 6844 2011-06-03 14:46:51Z dMetzger $
...
class XML_Feed_Parser_RSS2 extends XML_Feed_Parser_Type {
	...
	function getTextInput() {
		...
		if ($inputs->length > 0) {
			...
			return array (
					...
					'description' => $input->getElementsByTagName ( 'description' )->item ( 0 )->value,
	 ...
	 *        	The tag name (getSkipDays or getSkipHours)
	 * @return array|false
	 */
	 ...
	 *
	 * @param int $offset
	 *        	The position of the link within the feed. Starts from 0
	 * @param string $attribute
	 *        	The attribute of the link element required
	 * @param array $params
	 *        	An array of other parameters. Not used.
	 * @return string
	 */
