...
class XML_Feed_Parser_Atom extends XML_Feed_Parser_Type {
	 ...
	 * which it makes sense to map back to the RSS2 spec.
	 * Key is RSS2 version
	 ...
	 *
	 * @param string $method
	 *        	The name of the person construct we want
	 * @param array $arguments
	 *        	An array which we hope gives a 'param'
	 * @return string|false
	 */
	 ...
	 *        	the text construct node to be parsed
	 * @return String
	 ...
	 *
	 * @param int $offset
	 *        	the position of the link within the container
	 * @param string $attribute
	 *        	the attribute name required
	 * @param
	 *        	array an array of attributes to search by
