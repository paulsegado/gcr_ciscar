...
<!-- CISCAR la societe est obligatoire -->
				<div class="form-group">
					...
					<input type="text" class="is_required validate form-control" data-validate="isGenericName"  id="company" name="company" value="{if isset($smarty.post.company)}{$smarty.post.company}{/if}" />
				</div>
<!-- CISCAR on remplace SIRET par VAT -->				
				<div class="form-group">
					<label for="siret">{l s='VAT'}</label>
