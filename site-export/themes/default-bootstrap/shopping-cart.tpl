...
-->
				...
				<tr class="cart_total_voucher{if $total_discounts == 0} unvisible{/if}">
					<td colspan="{$col_span_subtotal}" class="text-right" style="border-top:0px;">
				...
				<tr class="cart_total_price" style="background:transparent;">
					<td colspan="{$col_span_subtotal}" class="total_price_container text-right" style="border-top: 0px solid #d6d4d4;border-right: 0px solid #d6d4d4;background:transparent;padding-left:0px;margin-left:0px">
						<span>{l s='Total ex VAT'}</span>
