...
*}
<!-- MODULE Block cart 
{l s='To be compute' mod='blockcart'}
{l s='Total amount for this product' mod='blockcart'}
{l s='Total qty for this produc' mod='blockcart'} 
		...
		<div class="clearfix">
			<div class="layer_cart_product col-xs-12 col-md-12">
				...
				<div class="layer_cart_product_info">
					...
					<div>
<!-- CISCAR						<strong class="dark">{l s='Quantity' mod='blockcart'}</strong> -->
						<span id="layer_cart_product_attributes"></span>
					</div>
					<div>
						<strong class="dark">{l s='Total qty for this produc' mod='blockcart'}</strong>
						<span id="layer_cart_product_quantity"></span>
					</div>
					<div>
						<strong class="dark">{l s='Total amount for this product' mod='blockcart'}</strong>
			...
			<div class="layer_cart_cart col-xs-12 col-md-6" style="display:none;">
				...
				<div class="layer_cart_row">
					<strong class="dark{if $shipping_cost_float == 0 && (!$cart_qties || $cart->isVirtualCart() || !isset($cart->id_address_delivery) || !$cart->id_address_delivery)} unvisible{/if}">
						...
						{$shipping_cost_float};{$cart_qties};{$cart->isVirtualCart()};{$cart->id_address_delivery}
