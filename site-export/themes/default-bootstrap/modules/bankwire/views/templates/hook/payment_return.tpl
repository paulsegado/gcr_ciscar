...
{if $status == 'ok'}
	...
	<div class="box">
<!-- CISCAR on supprime des informations de la confirmation de commande 
...
-->
<!-- CISCAR on force la reference de commande par le ID commande	
		{if isset($reference)}	
		...
		{/if}
-->		
		{l s='your order number is' mod='bankwire'} <strong>{$reference}</strong>
		
		<br />{l s='An email has been sent with this information.' mod='bankwire'}
<!-- CISCAR on supprime des informations de la confirmation de commande 
