...
*}
<div class="row">
	<div class="col-xs-12" {if !$visible_payment}style="display:none;"{/if}>
		<p class="payment_module">
			<a class="bankwire"  title="{l s='Pay by bank wire' mod='bankwire'}">
<!-- CISCAR on change le texteet on supprime le lien		
...
<div class="row">
<!-- CISCAR on verifie s'il faut afficher le template à partir de la nouvelle variable $visible_payment	-->
	<div class="col-xs-12" {if $visible_payment}style="display:none;"{/if}> 
