...
<!-- CISCAR On remplace le libelle par virement
	<h1 class="page-heading">{l s='Please choose your payment method'} 
-->
	<h1 class="page-heading">{l s='Transfer'} 
...
-->
	<h1 class="page-heading step-num"><span>3</span> {l s='Transfer'}</h1>
{/if}
...
{/if}
<!-- CISCAR on cumule dans la meme page, toutes les étapes -->
{if $advanced_payment_api}
    {include file="$tpl_dir./order-payment-advanced.tpl"}
{else}
   	{include file = "$tpl_dir./modules/bankwire/views/templates/hook/payment.tpl"}
   	{include file = "$tpl_dir./modules/bankwire/views/templates/front/payment_execution_auto.tpl"}
