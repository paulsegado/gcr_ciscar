...
class MenuModeNonRenaultView {
	...
	public function renderHTML() {
		...
		$aff .= '	<td><img src="include/images/kit/PuceGrise_petite.jpg"/> <a style="text-decoration:none;" href="?action=type&id=' . $aCategorie->getID () . '"><font face="Arial" size="2" color="#000000">Merchandising & Aménagement</font></a></td>';
		$aff .= '</tr>';
		$aff .= '<tr>';
		$aCategorie->SQL_SEARCH ( 'Matériel de garage' );
		$aff .= '	<td><img src="include/images/kit/PuceGrise_petite.jpg"/> <a style="text-decoration:none;" href="?action=type&id=' . $aCategorie->getID () . '"><font face="Arial" size="2" color="#000000">Mat�riel de garage</font></a></td>';
		$aff .= '</tr>';
		$aff .= '<tr>';
