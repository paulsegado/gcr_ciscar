...
class HomePageNonConnecteImprnetView {
	...
	public function renderHTML($msg = Null, $urlReturn = Null) {
		...
		$aff = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
				...
				<meta name="description" content="Accédez au portail CISCAR et découvrez tous les produits et services adaptés aux métiers de \'automobile : informatique, matériel de garage, Merchandising & Aménagement, papeterie et mailing."/>
		...
		$aff .= '<!-- Add jQuery library -->
			...
			function ciscarnl(urlReturn){
				...
				<meta name="description" content="CISCAR, Centrale d\'Achats des rÃ©seaux automobiles." />
				<meta name="robots" content="noindex, nofollow">
		...
		$aff .= '<table cellpadding="0" cellspacing="0">
							...
							<div class="index_left_content">
							  ...
							  <p>Simple et rapide ! Remplissez le formulaire en cliquant sur le bouton ci-dessous, puis profitez de tous les services CISCAR.<br />
								Commandez comme avant vos imprimés Renault via le menu jaune :<br />
								- les références produits ne changent pas,<br />
								- pas de paiement en ligne.<br />
							  </p>
							  <p><strong>Découvrez tous les autres produits CISCAR </strong>en plus des imprimés OFFICIELS Renault.</p>
							...
							<div class="index_right_content">
							  <h1>Commandez en ligne vos imprimés Renault</h1>
							  <p>Retrouvez tous vos imprimés VN/VO, APV, Rent et Divers, à la commande en ligne avec vos identifiants CISCAR :</p>';
		...
		$aff .= '             <div id="login_lost_success" class="display_none">Nous venons de vous envoyer un e-mail avec votre mot de passe.<br/>Merci de vÃ©rifier votre boite de rÃ©ception (ou courrier indÃ©sirable).</div>';
		$aff .= '</div></div>';
		// PUB
		...
		$aff .= '<script type="text/javascript">
				$("#formmotdepasseperdu").on("submit", function() {
					var mail = $("#mail").val();
					if(mail == "") {
						alert("Le champs doit Ãªtres remplis");
					} else {
						// appel Ajax
						$.ajax({
