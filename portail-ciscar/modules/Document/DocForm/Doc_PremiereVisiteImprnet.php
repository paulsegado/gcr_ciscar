	...
	public function render2HTML() {
					...
					<div id="wrapper">
						<div id="container">
						  ...
						  <div class="subscribe_content">
							  ...
							  <p>Remplissez le formulaire ci-dessous, puis profitez de tous les services CISCAR. Commandez comme avant vos imprimés Renault :<br/>
								- les références produits ne changent pas,<br/>
							  - pas de paiement en ligne.</p>
							  <p>Découvrez tous les autres produits CISCAR en plus des imprimés OFFICIELS Renault.</p>
						</div>';
		$aff .= '<script language="JavaScript">
				...
				function validationPremiereVisite()
				{
					...
					if($("#pPrenom").val()=="")
					{
						msg += "Le champ \'PrÃ©nom\' ne peut être vide\n";
						result = false;
					}
					if($("#pMail").val()=="")
					{
					...
					if($("#pTelephone").val()=="")
					{
						msg += "Le champ \'TÃ©lÃ©phone\' ne peut être vide\n";
						result = false;
					}
					if(!result)
					{
