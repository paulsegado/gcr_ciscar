	...
	public function renderHTML($msg = Null, $urlReturn = Null) {
		...
		if ($DealsID > 0 && ! $cmd) {
			...
			if (! $finDeal) {
				if ($QuantiteRestant == 0)
					$aff .= '
                      	<p style="font-family:Arial, Helvetica, sans-serif; font-size:22px; font-weight:bold; line-height:40px; text-align:center;margin-top:25px;">Vous pouvez <span style="font-size:30px;color:#e88320;">ENCORE</span> profiter du Pack<br/>
                        <span style="font-size:30px;color:#b6222e;">Chargeur + Testeur</span><br/>';
				else {
					...
					pour bénéficier du Pack<br> <span style="font-size:30px;color:#b6222e;">Chargeur + Testeur</span><br>';
				}
				// $aff .='
				...
				$aff .= '
                        ...
                        Vous ne pouvez plus commander le Pack<br><span style="font-size:30px;color:#b6222e;">Chargeur + Testeur</span><br/>';
			}
			$aff .= '
                        de batterie à<br>
  						<span style="color:#b6222e; font-size:30px;">409 €<sup>ht</sup></span> au lieu de <s>589 €</s><sup>ht</sup><br>                        
			...
			$aff .= '
                        <p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; text-align:justify; margin-top:15px;">
						<strong>CHARGEUR ultra compact 30-12HF :</strong>
						</p>
						<ul style="font-family:Arial, Helvetica, sans-serif; font-size:13px; list-style-type:none;">';
			// <li style="background: url(\'../../include/images/deal2/img/double-sim.jpg\') no-repeat;background-position: 0 9px; line-height: 34px; text-indent: 25px; "> <span>Double SIM**</span></li>
			// <li style="background: url(\'../../include/images/deal2/img/ecran.png\') no-repeat;background-position: 0 9px; line-height: 34px; text-indent: 25px; "> <span>Ecran 5" HD - OLED 1280 x 720.</span></li>
			// <li style="background: url(\'../../include/images/deal2/img/sd.png\') no-repeat;background-position: 0 8px; line-height: 28px; text-indent: 25px;"> Mémoire 16 Go. </li>
			// <li style="background-position: 0 10px; line-height: 2px; text-indent: 25px;">jusqu\'à 200Go de stockage sur Micro SD. </li>
			// <li style="background: url(\'../../include/images/deal2/img/photo.png\') no-repeat;background-position: 0 16px; line-height: 52px; text-indent: 25px;"> Appareil photo 8 mégapixels - Flash LED. </li>
			...
			$aff .= '
            			<li style="background-position: 0 9px; line-height: 16px; text-indent: -40px; "> <span><strong>-</strong> Chargement rapide de tous types de batteries</span></li>
            			<li style="background-position: 0 9px; line-height: 16px; text-indent: -32px; "> <span>(liquid, GEL, Start & Stop...).</span></li>
  						<li style="background-position: 0 8px; line-height: 16px; text-indent: -40px; "> <span><strong>-</strong> Détection automatique des batteries sulfatées + </span></li>
  						<li style="background-position: 0 8px; line-height: 16px; text-indent: -32px; "> <span>gestion de leur récupération.</span></li>';
			$aff .= '
            			</ul>';
			$aff .= '
                        <p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; text-align:justify; margin-top:15px;">
						<strong>TESTEUR de batterie BT551 :</strong>
						</p>
						<ul style="font-family:Arial, Helvetica, sans-serif; font-size:13px; list-style-type:none;">';
			$aff .= '
            			<li style="background-position: 0 9px; line-height: 16px; text-indent: -40px; "> <span><strong>-</strong> Appareil multifonctions, professionnel simple et </span></li>
            			<li style="background-position: 0 9px; line-height: 16px; text-indent: -32px; "> <span>précis avec imprimante intégrée.</span></li>
            			<li style="background-position: 0 9px; line-height: 16px; text-indent: -40px; "> <span><strong>-</strong> Test 3 technologies de batterie (scellées,</span></li>
            			<li style="background-position: 0 9px; line-height: 16px; text-indent: -32px; "> <span>ouvertes, Start & Stop), seules ou connectées,</span></li>
           				<li style="background-position: 0 8px; line-height: 16px; text-indent: -32px; "> <span>à partir de 1,5V, avec protection inversions</span></li>
            			<li style="background-position: 0 8px; line-height: 16px; text-indent: -32px; "> <span>de polarité. </span></li>';
			$aff .= '
            			</ul>
						<p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; text-align:justify; margin-top:15px;"><a href="#details" >&gt; En savoir plus sur les caractéristiques</a></p>            			
					</td>';
			if ($QuantiteRestant == 0)
				$aff .= '
					<td valign="top">
	            		...
	            		<img src="../../ftp/16/deal2/img/chargeur-testeur.png" height="520">
                    </td>
				</tr>';
			else
				$aff .= '
					<td valign="top">
	                    <p style="font-family:Arial, Helvetica, sans-serif; font-size:22px; font-weight:bold; line-height:40px; text-align:center;">Déjà <span style="font-size:30px;color:#0157a7;">' . $adeals->getQuantiteCmd () . '</span> acheteurs...<br/>
	            		<img src="../../ftp/16/deal2/img/chargeur-testeur.png" height="520">
                    </td>
				</tr>';
		...
		<table cellpadding="5" cellspacing="1" border="0">
			...
			$aff .= '
		    <tr>
		        <td rowspan="1"  style="border-right:#000033 1px solid;border-left:#000033 1px solid;"><p style="font-family:Arial, Helvetica, sans-serif; color:#FFFFFF; font-size:13px;text-align:left;">Pack Chargeur de batterie ultra compact 30-12HF + Testeur de batterie BT551 Stop&Start</p>
		        </td>
		        <td rowspan="1"  style="border-right:#000033 1px solid;"><p style="font-family:Arial, Helvetica, sans-serif; color:#FFFFFF; font-size:13px;text-align:center;">409,00 €</p>
		        </td>';
		...
		<p style="font-family:Arial, Helvetica, sans-serif; font-size:20px; font-weight:bold; text-align:center; color:#192d62; text-transform:uppercase;">5 jours</p>
		...
		if ($DealsID > 0 && ! $cmd)
			$aff .= '
		<tr>
		<td bgcolor="#eeeeee" colspan="2" style="border-top:1px solid #e1e1e1;" id="details" name="details">
		<p style="font-family:Arial, Helvetica, sans-serif; font-size:22px; font-weight:bold; text-align:left; ">Caractéristiques  du CHARGEUR ultra compact 30-12HF :</p>
		
		<p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; text-align:justify;">Réf. : GYS.029224 </p>
		<p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; text-align:justify;">IDEAL POUR VOS SHOWROOM&nbsp;: <br/>
		 
		- Intègre mode Showroom&nbsp;: fournit l\'énergie + entretient la batterie.<br/>
		- Maintien la tension : la tension à maintenir est  réglable selon les données constructeur 12 à 14,8 V.<br/>
		- Redémarrage automatique si coupure de courant.<br/>
		- Mode showroom peut être verrouillé.<br/>
		- Taille adaptée même pour le véhicule bas de caisse.
		</p>
		<p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; text-align:justify;">PARFAIT POUR LES ATELIERS&nbsp;:<br/>
		 
		- Intègre 2 modes pour fournir jusqu&rsquo;à 30 A pour un test  de gros consommateurs.<br/>
		- Maintien de la tension à 12 à 14,8 V lors d&rsquo;un TEST  DIAG et/ou REPROG.<br/>
		- Mode change batterie permet le maintien des données  lors des remplacements batterie.</p>
		 
		<p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; text-align:justify;">POLYVALENT AVEC LE MAGASIN&nbsp;: <br/>
		 
		- Rechargement de batteries stockées en magasin  destinées à la vente.</p>
		 
		<p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; text-align:justify;">REMISE VEHICULE NEUF ou OCCASION&nbsp;:<br/>
		 
		- Avant la présentation, rechargement de la batterie du  véhicule.</p>
		
		<p style="font-family:Arial, Helvetica, sans-serif; font-size:22px; font-weight:bold; text-align:left; ">Caractéristiques  du TESTEUR de batterie BT551 :</p>
		<p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; text-align:justify;">Réf. : GYS.055452 </p>
		<p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; text-align:justify;"><em>Boitier  résistant, écran LCD, imprimante thermique, câbles pinces détachables, livré en  valise avec 2 bobines papier</em>.</p>
		<p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; text-align:justify;">Le BT551 START-STOP est un testeur de batterie professionnel  simple et précis avec imprimante intégrée. Appareil multifonctions, il permet  d&rsquo;effectuer 3 types de test :<br />
		- Batterie 6-12 V : teste sa tension, son état de charge, etc.<br />
		- Démarreur 12-24 V : teste la tension en démarrage.<br />
		- Circuit de l&rsquo;alternateur 12-24 V (teste la tension à vide et  en charge ainsi que l&rsquo;ondulation du courant en charge).<br />
		</p>
		<p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; text-align:justify;">Test 3 technologies de batterie (scellées, ouvertes, start  &amp; stop) – Ultra précis – Test batterie seules ou connectées, à partir de 1,5 V  – Analyse Instantanée – Protection inversions de polarité.</p></td>
		</tr>';
		
		if ($DealsID > 0 && ! $finDeal && ! $cmd)
			$aff .= '			
			<tr>
			<td colspan="2" style="border-top:1px solid #e1e1e1;" id="conditions">
	        ...
	        Conditions particulières de cette offre :</p>
	 		<p style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:justify;">La validation de cette commande vaut commande ferme auprès de CISCAR. La validation de votre commande est sous réserve de l\'atteinte du volume nécessaire à la validation du deal. Votre commande sera alors validée et vous vous engagez à honorer la facture que vous recevrez. Dans le cas où le volume nécessaire à la validation du deal ne serait pas atteint, votre commande est alors annulée et vous ne serez pas facturé. Vous serez prévenu par email du suivi de votre commande. Cette offre est réservée exclusivement aux professionnels de l\'automobile.</p>
			</td>
			</tr>';
		else if (! $cmd)
			$aff .= '
