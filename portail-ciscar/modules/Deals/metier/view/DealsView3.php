	...
	public function renderHTML($msg = Null, $urlReturn = Null) {
		...
		if ($DealsID > 0 && ! $cmd) {
			$aff .= '
                ...
                <tbody>
 				<tr>
                                                ...
                                                <p style="text-align: left;font-family: Helvetica,sans-serif;color: #303030; font-size: 15px;"><strong>Équilibreuse motoris&eacute;e <br /><br />
                                                </strong><span style="text-align: left;font-family: Helvetica,sans-serif;color: #303030; font-size: 12px;">+ Plateau  universel diam 40mm<br />
												+ Bagues Renault/Dacia<br/>
                                            ...
                                            <tr>
                                              <td>
                                                <p style="text-align:center;font-family: Helvetica,sans-serif;color: #303030; font-size: 12px;">2 563,80 &euro;</p>
                                                </td>
                                                <td>
                                                <p style="text-align:center;font-family: Helvetica,sans-serif;color: #303030; font-size: 12px;">2 331,30 &euro;</p>
                                                </td>
                                                <td>
                                                <p style="text-align:center;font-family: Helvetica,sans-serif;color:#0157a7; font-size: 12px;"> <strong>2 016,50 €</strong></p>
                                                </td>
                                            </tr>
			...
			if (! $finDeal) {
				if ($QuantiteRestant == 0)
					$aff .= '
                      	<p style="font-family:Arial, Helvetica, sans-serif; font-size:22px; font-weight:bold; line-height:40px; text-align:center;margin-top:25px;">Vous pouvez <span style="font-size:30px;color:#e88320;">ENCORE</span> profiter d\'une<br/>
                        <span style="font-size:30px;color:#b6222e;">Équilibreuse motorisée</span><br/>';
				else {
					...
					pour bénéficier d\'une<br> <span style="font-size:30px;color:#b6222e;">Équilibreuse motorisée</span><br>';
				}
				// $aff .='
				...
				$aff .= '
                        ...
                        Vous ne pouvez plus commander <br><span style="font-size:30px;color:#b6222e;">l\'Équilibreuse motorisée</span><br/>';
			}
			$aff .= '
                        au prix de<br>
			...
			$aff .= '
						...
						<strong>ÉQUILIBREUSE ROUES MOTORISÉE AUTOMATIQUE 3D AFFICHAGE DIGITAL :</strong><br>GARANTIE 2 ans - 220 V - 90W
						</p>
			...
			$aff .= '
            			<li style="background-position: 0 9px; line-height: 16px; text-indent: -40px; "> <span><strong>+ Plateau centrage</strong> universel cylindrique ø40mm.</span></li>
  						<li style="background-position: 0 8px; line-height: 16px; text-indent: -40px; "> <span><strong>+ Bague</strong>  Renault/Dacia 59-60-66-71mm ø40.</span></li>
  						<li style="background-position: 0 8px; line-height: 16px; text-indent: -40px; "> <span style="color:#b6222e;"><strong>+ en cadeau</strong></span><span>&nbsp;1 trolley Serge Blanco !</span></li>';
			$aff .= '
            			</ul>';
			$aff .= '<p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; text-align:justify; margin-top:15px;">&gt; <a href="http://www.ciscar.fr/ftp/17/deal3/pdf/20170313_CISCAR_equilibreuse.pdf" target="_blank">En savoir plus sur les caractéristiques</a><br>            			
 						&gt; <a href="https://youtu.be/3QjC86sU2_o" target="_blank">Découvrir le produit en vidéo</a></p>            			
 						</td>';
			if ($QuantiteRestant == 0)
				$aff .= '
					<td valign="top">
	            		...
	            		<img src="../../ftp/17/deal3/img/equilibreuse.jpg" height="520">
                    </td>
				</tr>';
			else {
				$aff .= '
		...
		<table cellpadding="5" cellspacing="1" border="0"  width="100%">
			...
			$aff .= '
		    <tr>
		        <td rowspan="1"  style="border-right:#000033 1px solid;border-left:#000033 1px solid;"><p style="font-family:Arial, Helvetica, sans-serif; color:#FFFFFF; font-size:13px;text-align:left;">Équilibreuse motorisée</br>+ Plateau universel diam 40mm</br>+ Bagues Renault/Dacia</br>Réf. : OUT.EQ2000</p><span style="font-family:Arial, Helvetica, sans-serif; color:#FFFFFF; font-size:13px;text-align:left;">+ en cadeau 1 trolley Serge Blanco !</span>
		        </td>
		...
		if ($DealsID > 0 && ! $cmd)
			...
			</br></br>*&nbsp;Si le volume minimum de 7 équilibreuses n’est pas atteint, votre commande ne sera pas prise en compte. </br>&nbsp;&nbsp;Si vous désirez conserver votre commande, le tarif habituel sera appliqué.</p>
			</td>
			</tr>';
		else if (! $cmd)
			$aff .= '
